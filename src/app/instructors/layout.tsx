...
export const metadata: Metadata = {
  ...
  description: "Meet the experienced and passionate instructors at Clockwork Jiu Jitsu. Our team of black, brown, and blue belts brings years of expertise to help you grow in Brazilian Jiu Jitsu.",
