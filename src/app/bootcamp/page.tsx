          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="font-montserrat text-lg max-w-3xl mx-auto">
                ...
                Our next 4-week Beginners Course starts Tuesday, August 4th at 7:30 PM — designed specifically for people who are brand new to BJJ.
              </p>
            </motion.div>
              ...
              <div className="bg-gradient-to-r from-red-900/30 to-orange-900/30 border-2 border-red-500/50 p-8">
                <div className="text-center">
                  ...
                  <p className="font-montserrat text-lg mb-6">
                    Our August bootcamp starts Tuesday, August 4th at 7:30 PM — register below before spots are gone!
                  </p>
